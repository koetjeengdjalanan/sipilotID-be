<template>
    <PageComponent title="Event Forms">
        <!-- <pre>{{ forms.data }}</pre> -->
        <div
            v-if="forms.loading"
        ...
        <div v-if="!forms.loading" class="flex flex-col">
                    ...
                    <div class="mb-3 w-125">
                        ...
                        >
                            <option
                                ...
                                :key="itemPerPage"
                                :selected="itemPerPage === forms.perPage"
                                :value="itemPerPage"
                            >
                                {{ itemPerPage }}
                            </option>
