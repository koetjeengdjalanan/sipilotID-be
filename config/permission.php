...
return [
    ...
    'permissions'                      => [
        ...
        [
            ...
            'name'  => 'update post',
            'guard' => 'api',
            'route' => 'user.post.update',
        ], [
            'name'  => 'delete post',
            'guard' => 'api',
            'route' => 'user.post.delete',
        ],
        ...
        [
            ...
            'name'  => 'update tag',
            'guard' => 'api',
            'route' => 'user.tag.update',
        ], [
            'name'  => 'delete tag',
            'guard' => 'api',
            'route' => 'user.tag.delete',
        ],

        # Media CRUD Permission
        [
            'name'  => 'list media',
            'guard' => 'api',
            'route' => 'user.media.list',
        ], [
            'name'  => 'show media',
            'guard' => 'api',
            ...
            'name'  => 'update media',
            'guard' => 'api',
            'route' => 'user.media.update',
        ], [
            'name'  => 'delete media',
            'guard' => 'api',
            'route' => 'user.media.delete',
        ],
    ],
];
